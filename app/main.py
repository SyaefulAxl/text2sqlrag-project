...
# Disable HuggingFace symlinks on Windows (prevents privilege errors)
...
async def lifespan(app: FastAPI):
    """
    Manage the application lifespan using ASGI Lifespan Protocol.
    This replaces the deprecated on_event decorators.

    The lifespan context manager:
    - Runs startup code before the app starts accepting requests
    - Yields control to the app
    - Runs shutdown code when the app is being shut down
    """
    # Startup phase
    logger.info("=" * 60)
